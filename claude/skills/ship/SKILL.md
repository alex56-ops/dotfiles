...
3. Write a commit message in English that summarizes the changes as concisely as possible — a few words or one short sentence for small changes, more detail only when warranted. Do not use conventional commit prefixes. End the message with a Co-Authored-By line
